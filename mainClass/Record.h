...
// Dr.Raymer
// CS 3100-01
// This file was given to us. This file surves the purpose of creating a record object that will serve as a student object. The record class
// allows us to create a test record, a new record using the user input, functions to get the name, UID, and year if the record/student,
// set the year of the record and print out the record. 
// FILE: Record.h
